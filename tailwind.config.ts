    ...
    extend: {
      colors: {
        ...
        travel: {
          ...
          "primary-foreground": "hsl(var(--travel-primary-foreground))",
          secondary: "hsl(var(--travel-secondary))",
          "secondary-foreground": "hsl(var(--travel-secondary-foreground))",
          accent: "hsl(var(--travel-accent))",
          "accent-foreground": "hsl(var(--travel-accent-foreground))",
          dark: "hsl(var(--travel-dark))",
          "dark-foreground": "hsl(var(--travel-dark-foreground))",
          light: "hsl(var(--travel-light))",
          "light-foreground": "hsl(var(--travel-light-foreground))",
